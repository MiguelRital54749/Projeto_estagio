...
//        utils.log().info(msg);
    ...
    public String getText(WebElement e) throws IOException {
        String txt;
        switch(new GlobalParams().getPlatformName()){
            case "Android":
                txt = getAttribute(e, "text");
    ...
    public WebElement iOSScrollToElementUsingMobileScrollParent(WebElement parentE, String predicateString) {
